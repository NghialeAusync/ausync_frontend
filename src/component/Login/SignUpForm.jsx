    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className="sign-up-form">
            ...
            <div className="input-field">
                ...
                <input placeholder="Họ và tên" {...register("email", { required: true })} />
            </div>
            <div className="input-field">
            ...
            <input className="iBtn" type="submit" value="Đăng ký"/>
            <p className="social-text">Hoặc đăng ký nhanh với</p>
