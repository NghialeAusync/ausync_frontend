...
import sPic1 from '../../../Assets/30-days.png';
import sPic2 from '../../../Assets/calendar.png';
...
const Pricing = () => {
    return (
        <section id="pricing" className="pricing">
            <h4 className="miniTitle text-center">Báo giá</h4>
            <div className="text-center">
                <h2 className="sectionTitle">Bảng giá dịch vụ sao chép giọng nói</h2>
            </div>
            <Container>
